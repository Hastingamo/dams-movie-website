...
function Footers() {
  ...
  return (
    <div className="text-red-950 mt-24 flex flex-col sticky  w-[40rem] h-[4rem] xs:h-[4rem]  md:ml-8 md:h-[12rem]  md:w-[25rem] xp:w-[31rem] lg:w-[45rem] xl:w-[66rem] bg-[#d3baba88]">
      <div className="gap-5 ml-20 mt-6 flex flex-row md:hidden">
