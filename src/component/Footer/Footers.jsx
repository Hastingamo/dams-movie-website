...
function Footers() {
  ...
  return (
    <div className="text-red-950 mt-24 flex flex-col sticky  w-[40rem] h-[10rem] xs:h-[12rem]  md:ml-8 md:w-[25rem] md:mt-32 xp:w-[31rem] lg:w-[45rem] xl:w-[66rem] bg-[#d3baba88]">
