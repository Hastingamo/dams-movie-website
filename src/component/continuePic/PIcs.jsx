...
function PIcs(props) {
  return (
    <div className="h-[24.18rem] bg-[#1403037e] md:ml-3 md:h-[28.6rem] sm:bg-[#1403037e] rounded-lg lg:ml-10 lg:h-[35rem]">
      <img
        className="w-[25.3rem] h-[12.8rem] rounded-lg md:w-[14.5rem] md:h-[16.98rem] lg:w-[20rem] lg:h-[22rem]"
        src={props.img}
        alt=""
      />
      ...
      <img className="ml-2 w-[9rem] h-[3rem] md:ml-6 md:w-[11rem] lg:w-[9rem] xl:w-52" src={props.imgs2} alt="" />

      <div className="flex flex-row gap-10 md:gap-24 lg:gap-16">
