  ...
  return (
    <>
      <ReactCardFlip flipDirection="horizontal" isFlipped={isfliped}>
        <div className="ml-12 mt-12" onClick={flipeds}>
          <img
            src={Captainmarvel}
            alt=""
        ...
        <div
          className="bg-[#1403037e] md:ml-3 sm:bg-[#1403037e] rounded-lgw-[25.3rem] h-[12.8rem] rounded-lg  xm:w-[10rem] md:w-[14.5rem] md:h-[16.98rem] lg:w-[15rem] lg:h-[22rem] ml-12 mt-12 flex justify-center items-center"
          onClick={flipeds}
        >
